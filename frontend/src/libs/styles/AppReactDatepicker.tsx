...
const StyledReactDatePicker = styled(Box)<BoxProps>(({ theme }) => {
  ...
  return {
    ...
    '& .react-datepicker': {
      ...
      '& .react-datepicker__day-names': { marginBottom: 0 },
      '& .react-datepicker__day': {
        ...
        '&.react-datepicker__day--highlighted, &.react-datepicker__day--highlighted:hover': {
          ...
          '&.react-datepicker__day--selected': { backgroundColor: 'var(--mui-palette-primary-main) !important' }
        }
      },
      ...
      '& .react-datepicker__day--today': {
        ...
        '&:not(.react-datepicker__day--selected):not(:empty)': {
          ...
          '&:hover': { backgroundColor: 'var(--mui-palette-primary-mainOpacity)' },
          '&.react-datepicker__day--keyboard-selected': {
            backgroundColor: 'var(--mui-palette-primary-lightOpacity)',
            '&:hover': { backgroundColor: 'var(--mui-palette-primary-lightOpacity)' }
          }
        }
      },
      '& .react-datepicker__month-text--today': {
        ...
        '&:not(.react-datepicker__month-text--selected)': {
          ...
          '&:hover': { backgroundColor: `rgb(${theme.vars.palette.primary.mainChannel} / 0.04)` }
        }
      },
      ...
      '& .react-datepicker__day--keyboard-selected': {
        ...
        '&.react-datepicker__day--in-range:not(.react-datepicker__day--range-end)': {
          ...
          '&:hover': { backgroundColor: `rgb(${theme.vars.palette.primary.mainChannel} / 0.12) !important` }
        }
      },
      ...
      '& .react-datepicker__header__dropdown': {
        '& .react-datepicker__month-dropdown-container:not(:last-child)': { marginRight: theme.spacing(8) },
        ...
        '& .react-datepicker__month-option.react-datepicker__month-option--selected_month': {
          ...
          backgroundColor: 'var(--mui-palette-primary-lightOpacity)',
          '&:hover': { backgroundColor: 'var(--mui-palette-primary-mainOpacity)' },
          '& .react-datepicker__month-option--selected': { display: 'none' }
        },
      ...
      '& .react-datepicker__year-wrapper': { maxWidth: 205, justifyContent: 'center' },
      ...
      '&:not(.react-datepicker--time-only)': {
        '& .react-datepicker__time-container': {
          ...
          [theme.breakpoints.down('sm')]: { width: '5.5rem' },
          [theme.breakpoints.up('sm')]: { width: '7.5625rem' }
        }
      },
      '&.react-datepicker--time-only': {
        width: '7.5625rem',
        '& .react-datepicker__time-container': { width: '7.5625rem' }
      },
      '& .react-datepicker__time-container': {
        ...
        '& .react-datepicker__time-list-item': {
          ...
          borderRadius: 'var(--mui-shape-customBorderRadius-lg)',
          '&:focus, &:active': { outline: 0 },
          '&:hover': { backgroundColor: `${theme.palette.action.hover} !important` },
        ...
        '& .react-datepicker__time-box': { width: '100%' },
        '& .react-datepicker__time-list': {
          ...
          /* Handle */
          '&::-webkit-scrollbar-thumb': { borderRadius: 10, background: '#aaa' },
      ...
      '[data-skin="bordered"] &': { boxShadow: 'none', border: `1px solid var(--mui-palette-divider)` }
    },
