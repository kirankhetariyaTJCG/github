...
// MUI Imports
import { Box, Dialog, DialogTitle, DialogActions, IconButton, Typography, TextField, LoadingButton, DialogContent } from '@/Helper/MUIImports'
...
const AddImage = (props: ModelProps & { onSave?: (state: { title: string; src: string }) => void }) => {
  // Props
            ...
            {AppUtils.checkValue(cropImg?.src) ? (
              ...
              <>
                ...
                <Box
                  ...
                  fontSize={50}
                />
                <Typography sx={{ mt: 2, fontWeight: 600, fontSize: '1.2rem' }}>Upload Gallery Image</Typography>
              </>
            )}
          </LoadingButton>
        </DialogContent>
